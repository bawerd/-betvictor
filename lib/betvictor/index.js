...
betvictor.getSport = async (lang = 'en', id) => {
  return await getData(lang).then(d => { return d.indexed.sports[id]; });
};


betvictor.getEvents = async (lang = 'en') => {
  return await getData(lang, 'sports');
};
